 ...
 */
export type KoraPaymasterClient = Awaited<ReturnType<typeof createDefaultKoraClient>>;

/**
 * Creates a Kora paymaster client composed from Kit plugins.
 *
 ...
 * ```
 */
export async function createDefaultKoraClient(config: KoraPaymasterConfig) {
